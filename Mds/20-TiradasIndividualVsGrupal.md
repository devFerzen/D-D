...
Usar tirada individual cuando:
- cada personaje hace algo distinto,
- importa distinguir exito/fallo por personaje,
- cada accion tiene riesgo propio.

Usar tirada grupal cuando:
- todos intentan esencialmente lo mismo,
- el resultado importa a nivel colectivo,
